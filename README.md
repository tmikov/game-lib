...
Each dependency's own licence is vendored alongside it. This repository does
not aggregate or restate their terms — read the files:

| dependency | licence |
|---|---|
| sokol | `libs/sokol/LICENSE` |
| Dear ImGui | `libs/imgui/LICENSE` |
| miniaudio | `libs/miniaudio/LICENSE` |
| stb | `libs/stb/LICENSE` |
| Box2D | `libs/box2d/LICENSE` |
| EnTT | `libs/entt/LICENSE` |
| HandmadeMath | `libs/handmademath/LICENSE` |
| itlib | `libs/itlib/LICENSE` |
| sokol-shdc (vendored tool, not linked into your binary) | `tools/sokol-shdc/LICENSE` |
